 ...
 *	https://github.com/dersonluis/TimeLineAlcs
 *	
 *	O gráfico TimelineAlcs é um update do projeto
 *	Qlik Sense Extension Timeline (https://github.com/ralfbecher/QlikSense_Extension_Timeline)
 ...
 *	DIMENSÃO1 = ID
 *	DIMENSÃO2 = Tipos de fases do Projeto (Plan, Forecast e Actual)
 *	DIMENSÃO3 = Data início
 *	DIMENSÃO4 = Data término (Opcional - null se omitido)
 *	DIMENSÃO5 = Tipo Item (box (default), point, range, background)
 * 
 *	MEDIDA1 = Legenda
 *	MEDIDA2 = Cor
 *	MEDIDA3 = Agrupamento
        ...
        return {
            ...
            paint: function ($element, layout) {
                ...
                if (qData && qData.qMatrix) {
                    ...
                    if (layout.qHyperCube.qMeasureInfo.length > 2) {
                        ...
                        $.each(qData.qMatrix, function (i, e) {
                            if (e[7].qText && e[7].qText.trim() != '' && e[7].qText != '-') {
                                if ($.inArray(e[7].qText, auxGroup) == -1) {
									var aux = [];
									aux[0] = e[7].qText;
									aux[1] = e[0].qText;
                                    groupNames.push(aux);
                                    auxGroup.push(e[7].qText);
                                }
							/*	var contentOrder;
								if ($.inArray(e[7].qText, contentOrder) == -1) {
									switch(e[1].qText){
										case "Plan":
											contentOrder = 1;
											break;
                    ...
                    //                    }
					//ORDENA PLAN >> FORECAST >> ACTUAL
					//if(dataSet.length > 0){
					//	console.log('aqui');
					//	dataSet.sort(function (a, b) {
					//		/*var x = a.content === "Plan" ? 1 : a.content === "Forecast" ? 2 : 3,
					//			y = b.content === "Plan" ? 1 : b.content === "Forecast" ? 2 : 3;*/
					//		var x = a.id,
					//			y = b.id;								
					//		return x < y ? -1 : x > y ? 1 : 0;
					//	});
